<div class="navbar-default sidebar" role="navigation">
    <div class="sidebar-nav navbar-collapse">
        <ul class="nav" id="side-menu">
            ...
            <li>
                <a href="admin/data/danhsach"><i class="fa fa-bar-chart-o fa-fw"></i> GA data <span class="fa arrow"></span></a>
                <ul class="nav nav-second-level">
                    <li>
                        <a href="admin/data/danhsach"> All </a>
                        <a href="admin/data/VisitorsAndPageViews"> Visitors  and pageViews</a>
                        <a href="admin/data/MostVisitedPages"> Most visited pages</a>
                    </li>
                    <li>
                        {{--<a href="admin/slide/them"> Thêm </a>--}}
                    </li>
            ...
            <li>
                <a href="admin/user/danhsach"><i class="fa fa-users fa-fw"></i> Users <span class="fa arrow"></span></a>
                <ul class="nav nav-second-level">
                    <li>
