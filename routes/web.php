...
Route::group(['prefix'=>'admin','middleware'=> 'adminLogin'], function(){
   ...
   Route::group(['prefix'=>'tintuc'], function(){
    ...
    Route::group(['prefix'=>'data'], function(){
        Route::get('VisitorsAndPageViews', 'GAdataController@getVisitorsAndPageViews');
        Route::get('MostVisitedPages', 'GAdataController@getMostVisitedPages');
        Route::get('danhsach', 'GAdataController@getData');
    });
});
